...
public:
	...
	bool Insert(size_t pos, const char *s) const;			// returns true if buffer is too small
};
...
public:
	...
	bool Insert(size_t pos, const char *s) { return GetRef().Insert(pos, s); }	// returns true if buffer is too small
